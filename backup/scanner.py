...
class scanner:
	...
	def __init__(self,root,tickers_manager,scanner_process:scanner_process_manager,data):
		...
		self.finviz = finviz(self.tab1,tickers_manager,scanner_process,data)
...
class nasdaq_trader(pannel):


	def __init__(self,frame,tickers_manager,scanner_process:scanner_process_manager,data):
...
class finviz(pannel):
	...
	def __init__(self,frame,tickers_manager,scanner_process:scanner_process_manager,data):
		...
		self.setting = ttk.LabelFrame(frame,text="Scanner Settings") 
