...
def fetch_positions():
    try:
        response = requests.get(GET_POSITION_URL, timeout=1)
        ...
        for region in root.findall('.//Region'):
            ...
            for position in region.findall('Position'):
                ...
                #     volume *= -1
                # elif side != 'B':
                #     volume = 0  # Unknown or invalid side, treat as closed
...
def flush_expired_buffers(now_ms):
