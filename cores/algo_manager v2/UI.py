...
class UI(pannel):
	...
	def option_values(self):
		...
		self.management_plan_options = {TRENDRIDER,FIBO,EM_STRATEGY,EMASTRAT,ONETOTWORISKREWARD,HOLDTILCLOSE}#SCALPATRON #THREE_TARGETS,SMARTTRAIL,ANCARTMETHOD,ONETOTWORISKREWARD,ONETOTWORISKREWARDOLD,
