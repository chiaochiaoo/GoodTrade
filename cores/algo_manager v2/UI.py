...
class UI(pannel):
	...
	def option_values(self):
		...
		self.management_plan_options = {FIBO,EM_STRATEGY,EMASTRAT,ONETOTWORISKREWARD,HOLDTILCLOSE}#THREE_TARGETS,SMARTTRAIL,ANCARTMETHOD,ONETOTWORISKREWARD,ONETOTWORISKREWARDOLD,
