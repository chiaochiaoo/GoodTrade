...
class viewer:
	...
	def __init__(self, root=None):
		...
		self.er = extremerange(self.tab2)
		self.ev = extremevolume(self.tab3)

		self.oh = openhigh(self.tab6)
		self.ol = openlow(self.tab7)
		self.ff = firstfive(self.tab4)
...
class highlow:
	...
	def __init__(self,frame):
		...
		width = [8,10,12,10,10,12,10,10]
		labels = ["Ticker","Status","Range","Average","Current","Evaluation"]
...
class firstfive:
	...
	def __init__(self,frame):
		...
		width = [8,10,12,10,10,12,10,10]
		labels = ["Ticker","Status","Range","Today","Evaluation"]
...
class extremerange:
	...
	def __init__(self,frame):
		...
		width = [8,10,12,10,10,12,10,10]
		labels = ["Ticker","Status","1minRange","5minRange","Current","Last Alert"]
